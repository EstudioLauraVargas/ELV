    ...
    <div className="h-screen w-full pt-20 p-8 bg-slate-600 ">
     <Navbar/> 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
        ...
        >
          <div className="text-center">
            <h2 className="text-xl font-semibold text-pink-500 mb-2">Cargar Videos</h2>
            <p className="text-gray-600">Agregar Nuevos Videos.</p>
          </div>
        </Link>
        <Link
          to="/listarOrdenes"
        ...
        >
          <div className="text-center">
            <h2 className="text-xl font-semibold text-pink-500 mb-2">Gestionar Ordenes</h2>
            <p className="text-gray-600">Gestiona historial de transacciones.</p>
          </div>
        </Link>
        <Link
          to="/register"
